...
const DisplayButton: Component<{
  ...
  <button
    type="button"
    title={props.title}
    class="flex items-center justify-center gap-2 rounded-full font-semibold transition hover:bg-gray-600/70 hover:text-gray-50 md:h-auto md:w-auto md:rounded-lg md:px-4 focus:outline-none"
    classList={{
