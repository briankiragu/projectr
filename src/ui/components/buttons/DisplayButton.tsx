...
const DisplayButton: Component<{
  ...
  <button
    type="button"
    title={props.title}
    class="flex h-10 w-10 items-center justify-center gap-2 rounded-full font-semibold transition-colors hover:bg-gray-600/70 hover:text-gray-50 md:h-auto md:w-auto md:rounded-lg md:px-4"
    classList={{
