...
const PlaybackButton: Component<{
  ...
  <button
    type="button"
    title={props.title}
    class="group flex items-center justify-center gap-2 rounded-full p-2 font-semibold transition hover:bg-gray-600/70 hover:text-gray-50 focus:outline-none lg:h-auto lg:w-auto lg:rounded-lg lg:px-4 dark:text-gray-200"
    classList={{
