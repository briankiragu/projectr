...
const ProjectionButton: Component<{
  ...
  <button
    type="button"
    title={props.title}
    class="relative flex cursor-pointer gap-3 rounded-full  p-2 transition-colors hover:bg-teal-700 hover:text-teal-50 focus:outline-none md:h-auto md:w-auto md:px-6"
    classList={{
