...
const ProjectionButton: Component<{
  ...
  <Show when={props.isEnabled}>
    <button
      type="button"
      title={props.title}
      class="relative flex cursor-pointer gap-3 rounded-full bg-teal-300 p-2 transition-colors hover:bg-teal-700 hover:text-teal-50 md:h-auto md:w-auto md:px-6 focus:outline-none"
