...
const Prompter: Component = () => {
  ...
  return (
    <div class="flex min-h-dvh flex-col items-stretch gap-4 bg-black p-6">
      {/* Title */}
          ...
          <For each={nowPlaying()?.content}>
            {(verse, index) => (
              <div
                ...
                classList={{
                  "text-gray-100 md:text-4xl lg:text-7xl 2xl:text-8xl":
                    currentVerseIndex() === index(),
                  "text-gray-300 md:text-3xl lg:text-6xl 2xl:text-7xl":
                    currentVerseIndex() !== index(),
                }}
              >
