...
const Project: Component = () => {
  ...
  return (
    <div class="flex flex-col gap-4 items-stretch h-dvh p-4 bg-gray-100">
      ...
      >
        <h2 class="min-h-20 text-center text-wrap text-7xl underline font-black text-green-900 uppercase">
      ...
      <Show
        ...
        fallback={
          <div
            class="bg-contain bg-center bg-no-repeat bg-[url('/images/tvc-logo.webp')] rounded-lg flex-auto flex justify-center align-middle"
          ></div>
        }
      >
