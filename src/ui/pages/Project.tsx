...
const Project: Component = () => {
  ...
  return (
    <div class="flex flex-col gap-4 items-stretch h-dvh p-6 bg-gray-100">
      ...
      {/* Lyrics */}
      <div
        class="m-6 md:m-10 xl:m-20 bg-contain bg-center bg-no-repeat bg-[url('/images/tvc-logo.svg')] opacity-100 flex-auto flex items-center flex-col justify-start gap-4 rounded-lg px-6 py-4 text-center text-tvc-orange transition-colors"
